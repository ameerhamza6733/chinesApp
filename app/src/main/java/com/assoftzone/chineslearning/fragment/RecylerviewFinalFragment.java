...
/**
 * Created by AmeerHamza on 1/19/2018.
 */

public class RecylerviewFinalFragment extends RecyclerViewIntialsFragment {
    ...
    private static final String FINAL_ARRAY[] = {"1", "2","3"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter= new CustomAdapter(FINAL_ARRAY);
        if (mAdapter != null) {
